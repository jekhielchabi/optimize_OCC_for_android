#include <mobapptut_com_camera2videoimage_NativeClass.h>
...
JNIEXPORT jint JNICALL Java_mobapptut_com_camera2videoimage_NativeClass_convertGray
...
JNIEXPORT void JNICALL Java_mobapptut_com_camera2videoimage_NativeClass_lightDetection
(JNIEnv *, jclass, jlong addrRgba) {
Mat& frame = *(Mat*)addrRgba;
detectLight(frame);
}

JNIEXPORT jstring JNICALL Java_mobapptut_com_camera2videoimage_NativeClass_getJniStringBytes
        (JNIEnv* env, jclass){
    if (dem == 5) {
